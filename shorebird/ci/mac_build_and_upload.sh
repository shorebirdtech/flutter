...
# Usage:
# ./mac_build_and_upload.sh flutter_root engine_hash
#
# This is the main entrypoint for building and uploading macOS engine artifacts.
...
./internal/mac_setup.sh

# Then run the build.
./internal/mac_build.sh $ENGINE_ROOT

# Copy Shorebird engine artifacts to Google Cloud Storage.
./internal/mac_upload.sh $ENGINE_ROOT $ENGINE_HASH
