...
# Usage:
# ./win_build_and_upload.sh flutter_root engine_hash
#
# This is the main entrypoint for building and uploading Windows engine artifacts.
...
./internal/win_setup.sh

# Then run the build.
./internal/win_build.sh $ENGINE_ROOT

# Copy Shorebird engine artifacts to Google Cloud Storage.
./internal/win_upload.sh $ENGINE_ROOT $ENGINE_HASH
