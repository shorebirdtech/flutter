...
void main() {
  group('generateManifest', () {
    ...
    test('includes Android release artifacts', () {
      ...
      expect(manifest, contains(r'flutter_infra_release/flutter/$engine/android-arm64-release/linux-x64.zip'));
      expect(manifest, contains(r'flutter_infra_release/flutter/$engine/android-arm64-release/darwin-x64.zip'));
      expect(manifest, contains(r'flutter_infra_release/flutter/$engine/android-arm64-release/windows-x64.zip'));
      expect(manifest, contains(r'flutter_infra_release/flutter/$engine/android-arm64-release/symbols.zip'));

      // Android arm32
      expect(manifest, contains(r'flutter_infra_release/flutter/$engine/android-arm-release/artifacts.zip'));

      // Android x64
      expect(manifest, contains(r'flutter_infra_release/flutter/$engine/android-x64-release/artifacts.zip'));
    });
    ...
    test('includes Dart SDK for all platforms', () {
      ...
      expect(manifest, contains(r'flutter_infra_release/flutter/$engine/dart-sdk-linux-x64.zip'));
      expect(manifest, contains(r'flutter_infra_release/flutter/$engine/dart-sdk-windows-x64.zip'));
    });
    ...
    test('includes Maven artifacts', () {
      ...
      expect(manifest, contains(r'download.flutter.io/io/flutter/flutter_embedding_release/1.0.0-$engine/flutter_embedding_release-1.0.0-$engine.jar'));

      // arm64_v8a_release
      expect(manifest, contains(r'download.flutter.io/io/flutter/arm64_v8a_release/1.0.0-$engine/arm64_v8a_release-1.0.0-$engine.pom'));
      expect(manifest, contains(r'download.flutter.io/io/flutter/arm64_v8a_release/1.0.0-$engine/arm64_v8a_release-1.0.0-$engine.jar'));

      // armeabi_v7a_release
      expect(manifest, contains(r'download.flutter.io/io/flutter/armeabi_v7a_release/1.0.0-$engine/armeabi_v7a_release-1.0.0-$engine.pom'));

      // x86_64_release
      expect(manifest, contains(r'download.flutter.io/io/flutter/x86_64_release/1.0.0-$engine/x86_64_release-1.0.0-$engine.pom'));
    });
    ...
    test('includes macOS release artifacts', () {
      ...
      expect(manifest, contains(r'flutter_infra_release/flutter/$engine/darwin-x64-release/gen_snapshot.zip'));
    });
