...
class AOTSnapshotter {
  ...
  Future<int> build({
    ...
    final Directory shorebirdOutputDir = _fileSystem
        .directory(_fileSystem.path.join(outputDir.parent.path, 'shorebird'));
    ...
    final List<String> genSnapshotArgs = <String>[
      ...
      if (platform == TargetPlatform.ios) ...shorebirdDefaultGenSnapshotArgs,
    ];
